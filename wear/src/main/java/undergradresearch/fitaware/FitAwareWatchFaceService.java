...
public class FitAwareWatchFaceService  extends CanvasWatchFaceService {
    ...
    static int getComplicationId(
            FitAwareActivity.ComplicationLocation complicationLocation) {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
         ...
         *
         * Note: Data will only be present if the user has chosen a provider via the
         * settings activity for the watch face.
         */
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(
                    new WatchFaceStyle.Builder(FitAwareWatchFaceService.this)
        ...
        private void registerReceiver() {
            ...
            FitAwareWatchFaceService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            FitAwareWatchFaceService.this.unregisterReceiver(mTimeZoneReceiver);
        }

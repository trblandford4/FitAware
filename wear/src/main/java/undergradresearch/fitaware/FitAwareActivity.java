...
public class FitAwareActivity extends Activity implements View.OnClickListener {

    private static final String TAG = "FitAwareActivity";

    static final int COMPLICATION_CONFIG_REQUEST_CODE = 1001;

    /**
     * Used by associated watch face ({@link FitAwareWatchFaceService}) to let this
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLeftComplicationId =
                FitAwareWatchFaceService.getComplicationId(ComplicationLocation.LEFT);
        mRightComplicationId =
                FitAwareWatchFaceService.getComplicationId(ComplicationLocation.RIGHT);

        mWatchFaceComponentName = new ComponentName(getApplicationContext(),
                FitAwareWatchFaceService.class);
    ...
    public void retrieveInitialComplicationsData() {
        final int[] complicationIds = FitAwareWatchFaceService.getComplicationIds();
    ...
    private void launchComplicationHelperActivity(ComplicationLocation complicationLocation) {
        ...
        mSelectedComplicationId =
                FitAwareWatchFaceService.getComplicationId(complicationLocation);

        if (mSelectedComplicationId >= 0) {

            int[] supportedTypes =
                    FitAwareWatchFaceService.getSupportedComplicationTypes(
            ...
            startActivityForResult(
                    ComplicationHelperActivity.createProviderChooserHelperIntent(
                            ...
                            mSelectedComplicationId,
                            supportedTypes),
                    FitAwareActivity.COMPLICATION_CONFIG_REQUEST_CODE);
